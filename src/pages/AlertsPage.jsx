            ...
            <table className="dt">
              <thead>
                <tr>
                  ...
                  <th style={{width:90}}>ML result</th>
              ...
              <tbody>
                {filtered.map(a => (
                  <tr key={a.id}>
                    ...
                    <td>
                      {a.severity === 'critical' && <button className="act-btn danger">Isolate</button>}
                      {a.severity === 'warning'  && <button className="act-btn">Review</button>}
                    </td>
                  </tr>
                ))}
              </tbody>
